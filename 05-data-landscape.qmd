# The unique health data landscape {#sec-landscape}
...
The [Virtual Health Information Network](https://vhin.co.nz/) includes many researchers who are using the Integrated Data Infrastructure supported by Statistics NZ. VHIN's [IDI guides](https://vhin.co.nz/guides/) [@virtual_health_information_network_idi_2017] may be helpful in understanding what centralised data is available. The IDI is accessible through following a specific process.
...
## Data sovereignty {#sec-sovereignty}
