...
- Through a review of Aotearoa New Zealand health datasets, PDH has produced \[an interactive and updateable list of data\](https://data.precisiondrivenhealth.com) available in New Zealand. This includes data from \[Figure.nz\](https://figure.nz/) and many other sources.
...
:::{.callout-important}
Consider if existing patient consent is sufficient to cover use of the data. See _Consent_ below (**reference**).
:::
...
- [A useful checklist to address ethical and governance questions](http://ethicstoolkit.ai/)
