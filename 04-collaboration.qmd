...
Co-designing from the start and having a clinical champion/sponsor to ensure that developments can be incorporated in existing workflows so they can be used will set you up for success (see **Operational deployment** ([-@sec-deployment])).
...
* [Privacy Act 2020](https://www.legislation.govt.nz/act/public/2020/0031/latest/LMS23223.html): the legal basis for NZ organisations to work with data safely - also see **Ethics & privacy** ([-@sec-ethics])

* [Health Information Privacy Code 2020](https://privacy.org.nz/privacy-act-2020/codes-of-practice/hipc2020/) - also see **Ethics & privacy** ([-@sec-ethics])
