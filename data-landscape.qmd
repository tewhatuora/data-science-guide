...
- Through a review of Aotearoa New Zealand health datasets, PDH has produced [an interactive and updatable list of data](https://data.precisiondrivenhealth.com) available in New Zealand. This includes data from [Figure.nz](https://figure.nz/) and many other sources. ([@precision_driven_health_aotearoa_2022])
...
- NZ government's [Principles for the safe and effective use of data and analytics](https://www.stats.govt.nz/assets/Uploads/Data-leadership-fact-sheets/Principles-safe-and-effective-data-and-analytics-May-2018.pdf) ([@office_of_the_privacy_commissioner_principles_2018])
